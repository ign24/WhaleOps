...
export const ChatMessage: FC<Props> = memo(
  ({ message, messageIndex, onEdit, isStreaming = false }) => {
    ...
    const { displayedContent, isDraining } = useTypewriter(
    ...
    return (
      ...
      >
        <div className="relative m-auto flex text-base sm:w-[95%] 2xl:w-[60%] sm:p-2 md:py-6 lg:px-0">
          <div className="w-full dark:prose-invert overflow-hidden">
            {message.role === 'user' ? (
              ...
              <div className={`flex flex-col w-[90%]${isStreaming ? ' message-streaming' : ''}`}>
                <div className="flex flex-col gap-2">
                  ...
                  <div className="overflow-x-auto prose dark:prose-invert flex-1 w-full flex-grow max-w-full whitespace-normal">
                    ...
                    >
                      {prepareContent({
                        message: { ...message, content: isStreaming || isDraining ? displayedContent : message.content },
                        role: 'assistant',
                        intermediateStepsContent: false,
                        responseContent: true,
                      })}
                    </MemoizedReactMarkdown>
                    {(isStreaming || isDraining) && (
