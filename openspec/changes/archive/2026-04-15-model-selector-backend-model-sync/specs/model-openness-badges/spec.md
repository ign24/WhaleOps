...
#### Scenario: Openness labels match effective model licensing metadata
- **WHEN** la UI resuelve un modelo del catálogo activo de 4 modelos
- **THEN** el badge mostrado coincide con la clasificación operativa definida en `model-registry`
- **AND** no clasifica como `Open Source` un modelo marcado como licencia custom/no-OSI
