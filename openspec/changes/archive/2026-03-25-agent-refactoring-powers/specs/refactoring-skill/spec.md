...
The skill SHALL instruct the orchestrator to process files one at a time following a mandatory cycle. The orchestrator MUST NOT stop at showing snippets or proposing changes.
